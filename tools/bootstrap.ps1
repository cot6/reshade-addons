...
.\vcpkg install tiff[core,zip]:x86-windows-static
.\vcpkg install libpng:x86-windows-static

# 32-bit [tiff, libpng] (.lib /MD /MDd)
.\vcpkg install tiff[core,zip]:x86-windows-static-md
.\vcpkg install libpng:x86-windows-static-md

# 64-bit [tiff, libpng] (.lib /MT /MTd)
.\vcpkg install tiff[core,zip]:x64-windows-static
.\vcpkg install libpng:x64-windows-static

# 64-bit [tiff, libpng] (.lib /MD /MDd)
.\vcpkg install tiff[core,zip]:x64-windows-static-md
